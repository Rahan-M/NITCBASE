...
class BlockAccess {
 public:
  static int search(int relId, Attribute *record, char *attrName, Attribute attrVal, int op, int &count);
  ...
  static RecId linearSearch(int relId, const char *constAttrName, Attribute attrVal, int op, int &count);
